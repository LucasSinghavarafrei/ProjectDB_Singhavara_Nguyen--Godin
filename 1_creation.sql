...
CREATE TABLE ALBUM (
   ...
   FOREIGN KEY(Group_ID) REFERENCES GROUP_(Group_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE belongs_to_2_ (
   ...
   FOREIGN KEY(Fanclub_ID) REFERENCES FANCLUB(Fanclub_ID) ON DELETE CASCADE ON UPDATE CASCADE,
   FOREIGN KEY(Fan_ID) REFERENCES FAN(Fan_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
